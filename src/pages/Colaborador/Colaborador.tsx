    ...
    <div className="space-y-3">
      ...
      {dentistas.map((d) => {
        ...
        return (
          <div
            key={d.id}
            className="bg-white border border-gray-200 border-l-4 border-l-(--brand-primary) rounded-xl shadow-sm overflow-hidden"
          >
            <button
...
function NotificacoesTab({ colaboradorId }: { colaboradorId: string }) {
  ...
  const [notifs, setNotifs] = useState(() =>
    getNotificacoesParaUser(colaboradorId),
  );
  ...
  return (
    <div className="min-h-screen bg-(--brand-tertiary)">
      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        ...
        {tab === "notificacoes" && (
          <NotificacoesTab colaboradorId={colaboradorId} />
        )}
