      ...
      <main className="bg-(--brand-tertiary) min-h-screen">
        ...
        <section className="container_page py-20 text-center">
          ...
          <p className="text-xl text-(--text-color) max-w-2xl mx-auto leading-relaxed">
            ...
            — centralizando pacientes, dentistas, atendimentos e comunicação em
            um único lugar, de forma gratuita e acessível.
          </p>
        </section>

        {/* Cards section */}
        <section className="space-y-0">
          <div className="bg-white border-l-4 border-l-(--brand-primary) border-b border-gray-100 py-10">
          ...
          <div className="bg-linear-to-r from-(--card-primary) to-(--card-secondary) py-10">
            <div className="container_page">
              <h2 className="title2 mb-4">A COMPAIXÃO COMO VALOR</h2>
              <p className="text-xl text-(--brand-tertiary) leading-relaxed">
          ...
          <div className="bg-white border-l-4 border-l-(--brand-primary) border-b border-gray-100 py-10">
            <div className="container_page">
              ...
              <p className="text-lg text-(--text-color) leading-relaxed">
                ...
                é diferente: somos human-first e não abrimos mão disso. A
          ...
          <div className="bg-(--brand-tertiary) border-b border-gray-200 py-10">
        ...
        <section className="container_page py-20 text-center">
          ...
          <p className="text-lg text-(--text-color) max-w-xl mx-auto leading-relaxed">
