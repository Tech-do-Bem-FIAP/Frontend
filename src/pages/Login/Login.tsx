...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-(--brand-tertiary) flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-8">
          ...
          <p className="text-xs text-(--text-secondary-color) text-center mt-6">
            Acesso de teste: <strong>colaborador</strong> /{" "}
            <strong>dentista</strong> — senha: <strong>1234</strong>
          </p>
        </div>
      </div>
    </div>
